import numpy as np
import random
def to_random_timesurface_numpy(
    events,
    sensor_size,
    ordering,
    ...
    Args:
        ...
        tau (int, int): time constant to decay events around occuring event with. randomised between the two ints.
    ...
    tau = random.randint(tau_range[0], tau_range[1])
