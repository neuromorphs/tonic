...
@pytest.mark.parametrize("n, randomize_n, seed", [(100, True, 32), (100, False, 128), (0, False, 64)])
def test_transform_uniform_noise(n, randomize_n, seed):
    orig_events, sensor_size = create_random_input()

    transform = transforms.UniformNoise(sensor_size=sensor_size, n=n, randomize_n=randomize_n, seed=seed)
    ...
    rand_n = randgen.integers(n+1) if randomize_n else n
