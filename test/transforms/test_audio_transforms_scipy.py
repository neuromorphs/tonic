...
def test_standardize_data_length():
    from tonic.audio_transforms_scipy import FixLength
    sdl = FixLength(100, 1)
...
def test_bin():
    import numpy as np
    from tonic.audio_transforms_scipy import Bin
...
def test_linear_butter_filter_bank():
    from tonic.audio_transforms_scipy import LinearButterFilterBank
    import numpy as np
...
def test_mel_butter_filter_bank():
    from tonic.audio_transforms_scipy import MelButterFilterBank
    import numpy as np
...
def test_add_noise():
    ...
    from tonic.audio_transforms_scipy import AddNoise
