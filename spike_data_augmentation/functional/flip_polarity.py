...
def flip_polarity_numpy(events, flip_probability=0.5, ordering=None):
    """
    Flips polarity of individual events with probability
    flip_probability:


    Arguments:
    - events - ndarray of shape [num_events, num_event_channels]
    - flip_probability - probability of flipping individual event
                         polarities
    ...
    Returns:
    - events - returns every event with p' = -p at flip_probability
               or p' = p at 1 - flip_probability
    """
